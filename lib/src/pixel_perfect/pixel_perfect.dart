...
/// This source code has been copied her from the pixel_perfect package, to make it easier to debug and change.
/// TODO: if I can find a nice fix for the overflow issue, fork repository, create a PR and reference the fork.
/// TODO: need to investigate how to get the PixelPerfect widget to clip image when it is too big.
